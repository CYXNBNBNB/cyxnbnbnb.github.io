...
\begin{tabular}{@{} m{0.72\textwidth} m{0.25\textwidth} @{}}
    \begin{minipage}[t]{0.98\linewidth}
        \begin{flushleft}
            ...
            \begin{tabular}{@{} l @{\hspace{3mm}} l @{}} 
                \hspace*{6.5mm}\textbf{| 性别:}    & 男 \\
                \hspace*{6.5mm}\textbf{| 出生年月:}    & 2001年10月30日 \\
                \hspace*{6.5mm}\textbf{| 政治面貌:}    & 共青团员 \\
                \hspace*{6.5mm}\textbf{| 籍贯:}    & 浙江金华 \\
                \hspace*{6.5mm}\textbf{| 固定住址:}    & 杭州市萧山区宁围街道翡翠江南华庭3幢3单元602室 \\
                \hspace*{6.5mm}\textbf{| 最高学历:}    & 硕士 \\
                \hspace*{6.5mm}\textbf{| 专业:}    & 应用商业分析 \\

                \hspace*{6.5mm}\textbf{| 联系方式:}    & +86 139-5799-2893 \\

                \hspace*{6.5mm}\textbf{| 电子邮箱:} & 
                  \href{mailto:cyxnbnb@bu.edu}{cyxnbnb@bu.edu} \quad / \quad
    ...
    \end{minipage}
    &
    \raisebox{-1.05\height}{\includegraphics[width=0.75\linewidth,keepaspectratio]{images/1_inch.jpg}} % height控制图片高度  width控制图片大小
\end{tabular}
\vspace*{2mm}
...
\begin{large}{\bf 专业技能}
  ...
  \hrule
\end{large}
* **英语水平**: CET4、CET6、TOEFL(97/120)
* **专业技能**: Python, R, MATLAB, SQL, C, SPSS, Stata, Microsoft Word, PowerPoint, Excel
