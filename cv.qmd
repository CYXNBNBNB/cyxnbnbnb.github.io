...
\begin{large}{\bf RESEARCH PROJECTS}
  ...
  \end{multicols}
  \begin{multicols}{2}
    \parbox{1.4\linewidth}{\textbf{Data-Driven Career Analysis}: Evaluating Personal Job Market Prospects in 2024}
  \end{multicols}
  \vspace{-0.10cm}
\end{large}
...
\begin{large}
  \begin{multicols}{2}
  \parbox{1.6\linewidth}{\bf Domestic(U.S.) and International Equity Portfolio research}
