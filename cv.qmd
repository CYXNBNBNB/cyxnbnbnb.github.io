...
\begin{tabular}{@{} m{0.72\textwidth} m{0.25\textwidth} @{}}
    \begin{minipage}[t]{0.98\linewidth}
        \begin{flushleft}
            ...
            \begin{tabular}{@{} l @{\hspace{3mm}} l @{}} 
                \textbf{Email:}    & \href{mailto:cyxnbnb@bu.edu}{cyxnbnb@bu.edu} \\
                                   & \href{mailto:cyxnbnbnb@gmail.com}{cyxnbnbnb@gmail.com} \\[1mm]
                
                \textbf{Phone:}    & +1 (857) 256-4713 \\
                                   & +86 139-5799-2893 \\[0.5mm]
                
                \textbf{Address:}  & Apt 12, 5 Walbridge St. Boston, MA 02115 \\[0.5mm]
                
                \textbf{Link:}     & \href{https://cyxnbnbnb.github.io/}{cyxnbnbnb.github.io} \\
                
                \textbf{Home Page:} & \href{https://github.com/CYXNBNBNB}{github.com/CYXNBNBNB}
            \end{tabular}
    ...
    \end{minipage}
    &
    \raisebox{-0.7\height}{\includegraphics[width=\linewidth,keepaspectratio]{images/myphoto.jpg}}
\end{tabular}
\vspace*{2mm}
